...
__lt__(other) -> TODO: COMING SOON
__le__(other) -> TODO: COMING SOON
...
__ge__(other) -> TODO: COMING SOON
__gt__(other) -> TODO: COMING SOON
(WRAPPER)
equals(other) -> wrapper for __eq__(other) object method
notequals(other) -> wrapper for __ne__(other) object method

(UNARY OPERATORS)
__pos__() # TODO: COMING SOON
__neg__() # TODO: COMING SOON
__abs__() # TODO: COMING SOON
